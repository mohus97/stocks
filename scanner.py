...
def format_ig_demo_status(status):
    ...
    auto_line = '⚠️ IG_AUTO_TRADE=true detected, but execution is NOT enabled in this connection-test build.' if auto_requested else '🔒 IG auto execution: OFF (connection test only)'
    return (
        '🤖 IG DEMO CONNECTED\n'
        f'✅ Environment: DEMO\n'
